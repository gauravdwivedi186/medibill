        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg h-screen">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <select
              ...
              className="bg-gray-50 w-36 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 outline-none"
            >
